...
internal class ParticipantGridViewModelUnitTest : ACSBaseTestCoroutine() {
    ...
    fun participantGridViewModel_update_then_notifyRemoteParticipantsSharedFlow() =
        runScopedTest {
            ...
            val pipState = PictureInPictureState(PictureInPictureStatus.NONE)

            // act
            participantGridViewModel.update(modifiedTimestamp, remoteParticipantsMap, listOf(), 0, pipState)
    ...
    fun participantGridViewModel_update_when_inputMoreThanSixUsers_then_notifyRemoteParticipantsSharedFlowWithSixUsers() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(modifiedTimestamp, remoteParticipantsMap, dominantSpeakersInfo, System.currentTimeMillis(), pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleWithSameList_then_notifyRemoteParticipantsSharedFlowOnlyOnce() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(modifiedTimestamp, remoteParticipantsMap, dominantSpeakersInfo, System.currentTimeMillis(), pipState)
            participantGridViewModel.update(100, remoteParticipantsMap.toMutableMap(), dominantSpeakersInfo, 100, pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleWithSameStateModifiedTimeStamp_then_notifyRemoteParticipantsSharedFlowOnlyOnce() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(modifiedTimestamp, remoteParticipantsMap.toMutableMap(), dominantSpeakersInfo, modifiedTimestamp, pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleWithDifferentStateModifiedTimeStamp_then_notifyRemoteParticipantsSharedFlowTwice() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(modifiedTimestamp, remoteParticipantsMap.toMutableMap(), listOf(), 0, pipState)
            ...
            participantGridViewModel.update(100, remoteParticipantsMapNew.toMutableMap(), listOf(), 0, pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleWith_addedUserList_then_notifyRemoteParticipantsStateFlow() =
        runScopedTest {
            ...
            // act with new list
            participantGridViewModel.update(300, remoteParticipantsMapNew.toMutableMap(), dominantSpeakersInfoNew, 300, pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleWith_removedUserList_then_notifyRemoteParticipantsStateFlow() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(89, remoteParticipantsMap.toMutableMap(), dominantSpeakersInfo, 89, pipState)
    ...
    fun participantGridViewModel_update_when_calledWith_moreThanSix_then_notifyRemoteParticipantsShared_with_sortedModifiedList() =
        runScopedTest {
            ...
            // act
            participantGridViewModel.update(5, remoteParticipantsMap.toMutableMap(), dominantSpeakersInfo, 5, pipState)
    ...
    fun participantGridViewModel_update_when_calledMultipleTimesWith_moreThanSix_then_notifyRemoteParticipantsShared_with_sortedModifiedList() =
        runScopedTest {
            ...
            // act with new list
            participantGridViewModel.update(10, remoteParticipantsMapNew.toMutableMap(), dominantSpeakersInfoNew, 10, pipState)
