...
internal class SetupControlBarViewModel(
    ...
    private fun shouldCameraButtonBeVisible(
        ...
        return audioVideoMode == CallCompositeAudioVideoMode.AUDIO_AND_VIDEO &&
            (roleHint == null || capabilitiesManager.hasCapability(roleHint, CallCompositeParticipantCapabilityType.TURN_VIDEO_ON))
    }
    ...
    private fun shouldMicButtonBeVisible(roleHint: ParticipantRole?): Boolean {
        ...
        return capabilitiesManager.hasCapability(roleHint, CallCompositeParticipantCapabilityType.UNMUTE_MICROPHONE)
    }
