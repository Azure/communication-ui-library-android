...
internal class InCallSecondaryNotificationViewModel {
    ...
    /*fun update(callingState: CallingState) {
        ...
        shouldShowIsSpeakingWhileMutedMessageStateFlow.value = callingState.isSpeakingWhileMicrophoneIsMuted
        _shouldShowIsSpeakingWhileMutedMessageStateFlow.value = callingState.isSpeakingWhileMicrophoneIsMuted
        displayInCallNotificationFlow.value = callingState.isSpeakingWhileMicrophoneIsMuted
