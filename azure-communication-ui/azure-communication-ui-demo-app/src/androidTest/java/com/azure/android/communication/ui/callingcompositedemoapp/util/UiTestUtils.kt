...
object UiTestUtils {
    ...
    @Throws(NoMatchingViewException::class)
    fun checkViewIdAndTextIsNotEnabled(@IdRes viewId: Int, text: String): ViewInteraction =
        onView(
            allOf(
                withId(viewId),
                withText(text)
    ...
    @Throws(NoMatchingViewException::class)
    fun checkViewIdAndTextIsEnabled(@IdRes viewId: Int, text: String): ViewInteraction =
        onView(
            allOf(
                withId(viewId),
                withText(text)
