...
internal class MicStatusHook : AccessibilityHook() {
    ...
    override fun message(lastState: ReduxState, newState: ReduxState, context: Context): String {
        return when (newState.localParticipantState.audioState.operation) {
            AudioOperationalStatus.ON -> context.getString(R.string.azure_communication_ui_setup_view_button_mic_on)
            AudioOperationalStatus.OFF -> context.getString(R.string.azure_communication_ui_setup_view_button_mic_off)
...
internal class CameraStatusHook : AccessibilityHook() {
    ...
    override fun message(lastState: ReduxState, newState: ReduxState, context: Context): String {
        return when (newState.localParticipantState.cameraState.operation) {
            CameraOperationalStatus.ON -> context.getString(R.string.azure_communication_ui_setup_view_button_video_on)
            CameraOperationalStatus.OFF -> context.getString(R.string.azure_communication_ui_setup_view_button_video_off)
            else -> ""
        }
    }
}
