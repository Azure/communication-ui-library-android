...
internal class ErrorInfoView(private val rootView: View) {
    ...
    private fun getErrorMessage(
        ...
        return when (it.communicationUIErrorEvent) {
            CommunicationUIErrorEvent.CALL_END -> localizationProvider.getLocalizedString(
            ...
            CommunicationUIErrorEvent.CALL_JOIN -> localizationProvider.getLocalizedString(
