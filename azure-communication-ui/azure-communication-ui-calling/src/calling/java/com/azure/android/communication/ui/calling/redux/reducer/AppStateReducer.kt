...
internal class AppStateReducer(
    ...
    private val externalOverlayReducer: ExternalOverlayReducer,
) :
    ...
    override fun reduce(state: AppReduxState, action: Action): AppReduxState {
        ...
        appState.externalOverlayState = externalOverlayReducer.reduce(state.externalOverlayState, action)
        return appState
    }
}
