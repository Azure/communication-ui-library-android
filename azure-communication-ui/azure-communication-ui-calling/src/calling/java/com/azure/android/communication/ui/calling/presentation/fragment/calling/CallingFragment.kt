...
import com.azure.android.communication.ui.calling.presentation.fragment.calling.externaloverlay.ExternalOverlayView
...
internal class CallingFragment :
    ...
    private lateinit var externalOverlayView: ExternalOverlayView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        infoHeaderView.start(
            ...
            holder.container.configuration.customButtons
        )
        ...
        externalOverlayView = view.findViewById(R.id.azure_communication_ui_calling_call_external_overlay)
        externalOverlayView.start(viewLifecycleOwner, viewModel.getExternalOverlayViewModel())
