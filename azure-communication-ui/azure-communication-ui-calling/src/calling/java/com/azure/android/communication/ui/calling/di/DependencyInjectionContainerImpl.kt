...
import com.azure.android.communication.ui.calling.redux.middleware.IntegrationMiddlewareImpl
...
import com.azure.android.communication.ui.calling.redux.reducer.ExternalOverlayReducerImpl
...
internal class DependencyInjectionContainerImpl(
    ...
    val integrationManager by lazy {
        IntegrationManager(configuration.integrationBridge)
    }
    ...
    private val externalOverlayReducer get() = ExternalOverlayReducerImpl()

    // Middleware
    private val appMiddleware get() = mutableListOf(callingMiddleware, integrationMiddleware)
    ...
    private val integrationMiddleware: Middleware<ReduxState> by lazy {
        IntegrationMiddlewareImpl(integrationManager)
    }
