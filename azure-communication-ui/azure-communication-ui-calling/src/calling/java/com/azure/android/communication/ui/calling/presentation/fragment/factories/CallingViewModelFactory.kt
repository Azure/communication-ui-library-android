...
internal class CallingViewModelFactory(
    ...
    private val floatingHeaderViewModel by lazy {
        InfoHeaderViewModel(store::dispatch)
    }
    ...
    private val externalOverlayViewModel by lazy {
        ExternalOverlayViewModel()
    }
    ...
    fun provideExternalOverlayViewModel(): ExternalOverlayViewModel {
