...
import com.azure.android.communication.ui.calling.presentation.fragment.calling.externaloverlay.ExternalOverlayViewModel
...
internal class CallingViewModel(
    ...
    private val externalOverlayViewModel = callingViewModelProvider.provideExternalOverlayViewModel()
    ...
    fun getExternalOverlayViewModel(): ExternalOverlayViewModel {
        return externalOverlayViewModel
    }
    ...
    override fun init(coroutineScope: CoroutineScope) {
        ...
        externalOverlayViewModel.init(state.externalOverlayState)
    ...
    override suspend fun onStateChange(state: ReduxState) {
        ...
        externalOverlayViewModel.update(state.externalOverlayState)
