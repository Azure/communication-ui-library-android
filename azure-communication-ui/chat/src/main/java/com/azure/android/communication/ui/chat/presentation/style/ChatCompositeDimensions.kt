...
internal data class ChatCompositeDimensions(
    ...
    val messageOuterPadding: PaddingValues = PaddingValues(
        start = 0.dp,
        end = 0.dp,
        top = 1.dp,
        bottom = 1.dp
    ),
    val messageInnerPadding: PaddingValues = PaddingValues(
        start = 8.dp,
        end = 8.dp,
        top = 8.dp,
        bottom = 8.dp
    ),
    val systemMessagePadding: PaddingValues = PaddingValues(
        start = 20.dp,
        end = 5.dp,
        top = 8.dp,
        bottom = 8.dp
    ...
    val unreadMessagesIndicatorPadding: PaddingValues = PaddingValues(
        start = 0.dp,
        end = 0.dp,
        top = 0.dp,
        bottom = 4.dp
    ),
    val unreadMessagesIndicatorIconPadding: PaddingValues = PaddingValues(
        start = 10.dp,
        end = 0.dp,
        top = 0.dp,
        bottom = 0.dp
    ...
    val dateHeaderPadding: PaddingValues = PaddingValues(
        start = 0.dp,
        end = 0.dp,
        top = 12.dp,
        bottom = 4.dp
    ),
    val messageAvatarPadding: PaddingValues = PaddingValues(
        start = 0.dp,
        end = 4.dp,
        top = 0.dp,
        bottom = 0.dp
    ),
    val messageRead: PaddingValues = PaddingValues(
        start = 3.dp,
        end = 4.99.dp,
        top = 3.dp,
        bottom = 3.dp
